...
def main(engine_type, m, S, a, b, c, g, step):
    
    engine_type = get_engine_type(engine_type)
    ...
    heights['h']
    hei = []
    for data in heights['h']:
        hei.append(data)
    
    return_dict = {
    'V_min_list': V_min_list,
    "V_max_list" : V_max_list,
    "V_w_list" : V_w_list,
    "V_gamma_list" : V_gamma_list,
    "gamma_max_list" : gamma_max_list,
    "w_max_list" : w_max_list,
    "heights": hei,
    "t_min_list": t_min_list
    }
